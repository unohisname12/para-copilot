  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content" style={{ width: "560px" }}>
        ...
        <div className="modal-body">{emailLoading ? (<div style={{ textAlign: "center", padding: "40px", color: "#4ade80" }}>AI drafting...</div>) : (<textarea spellCheck="true" lang="en" value={emailDraft} onChange={e => setEmailDraft(e.target.value)} className="data-textarea" style={{ height: "260px", fontFamily: "inherit", lineHeight: "1.6" }} />)}</div>
