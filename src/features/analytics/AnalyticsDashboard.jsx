      ...
      <div className="panel" style={{ padding: "14px", borderLeft: "3px solid #a78bfa" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
          <div>
            ...
            <div style={{ display: "flex", gap: "4px", flexWrap: "wrap", marginTop: "4px" }}>{group.students.map(id => <span key={id} style={{ fontSize: "10px", color: allStudents[id]?.color, background: allStudents[id]?.color + "15", padding: "1px 7px", borderRadius: "20px" }}>{resolveLabel(allStudents[id], "compact")}</span>)}</div>
          </div>
          <div style={{ display: "flex", gap: "4px" }}>
